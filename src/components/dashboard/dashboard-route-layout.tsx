...
/** Layout partilhado pelas vistas do painel (sub-rotas). */
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-pretty text-sm text-muted-foreground">
                Explore o que pode fazer já, visualize padrões dos últimos sete dias, veja uma vista mensal quando estiver pronta
                ou use o calendário de prazos.
              </p>
            </div>
          </div>
          <DashboardSubNav className="mt-6" />
        </header>
