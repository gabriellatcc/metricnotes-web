...
import {DroppableArea} from "@/components/ui/imported-calendar/droppable-area";
import {groupEvents} from "@/components/ui/imported-calendar/helpers";
import type {IEvent} from "@/components/ui/imported-calendar/interfaces";
import {CalendarTimeline} from "@/components/ui/imported-calendar/calendar-time-line";
import {RenderGroupedEvents} from "@/components/ui/imported-calendar/render-grouped-events";
import {
    WeekViewMultiDayEventsRow
} from "@/components/ui/imported-calendar/week-view-multi-day-events-row";
...
export function CalendarWeekView({singleDayEvents, multiDayEvents}: IProps) {
    const {selectedDate, use24HourFormat, dateLocale, messages} = useCalendar();
    ...
    return (
        ...
        >
            <motion.div
                ...
                transition={transition}
            >
                <p>{messages.weekViewMobileHintLine1}</p>
                <p>{messages.weekViewMobileHintLine2}</p>
            </motion.div>
            ...
            >
                ...
                <ScrollArea className="h-[calc(100dvh-12rem)] min-h-[240px]" type="always">
                    <div className="flex">
                        {/* Hours column */}
